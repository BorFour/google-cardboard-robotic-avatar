...
Aquí se muestra cómo cambia el sistema con el tiempo y dados ciertos eventos. Toda esta evolución puede observarse prácticamente en el diagrama \ref{fig:diagrama_actividad_app}, correspondiente al cliente.
...
Como se explica en el apartado de implementación, esta parte del sistema no se ha llevado a cabo programando, si no utilizando una herramienta \textit{open source}, por lo que no procede un desarrollo del diseño de los servidores de vídeo.

\subsection{Servidor de control}
%\todo[inline]{Diseño: \currentname}

En el propio servidor de control son dos las clases más importantes, como se detalla en la figura \ref{fig:diagrama_clases_servidor_control}:
