...
Como se explica en el apartado de implementación, esta parte del sistema no se ha llevado a cabo programando, sino utilizando una herramienta \textit{open source}, por lo que 1no procede un desarrollo del diseño de los servidores de vídeo.
