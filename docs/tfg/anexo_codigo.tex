...
\begin{figure}[H]
	\inputminted[firstline=7,lastline=12]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/AddressManager.java}
...
\begin{figure}[H]
	\inputminted[firstline=13,lastline=18]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/AddressManager.java}
...
\begin{figure}[H]
	\inputminted[firstline=17,lastline=24]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/PositionSender.java}
	\caption{\textbf{Atributos de la clase}. }
	\label{fig:positionsender_atributos}
\end{figure}

\begin{figure}[H]
	\inputminted[firstline=27,lastline=33]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/PositionSender.java}
	\caption{\textbf{Método constructor}. }
	\label{fig:positionsender_constructor}
\end{figure}

\begin{figure}[H]
	\inputminted[firstline=36,lastline=41]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/PositionSender.java}
...
\begin{figure}[H]
	\inputminted[firstline=12,lastline=22]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/FormActivity.java}
	\caption{\textbf{Definición de la clase, AddressManager y \textit{onCreate()}}. }
	\label{fig:formactivity_clase}
\end{figure}

\begin{figure}[H]
	\inputminted[firstline=24,lastline=49]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/FormActivity.java}
...
\begin{figure}[H]
	\inputminted[firstline=52,lastline=57]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/FormActivity.java}
...
\begin{figure}[H]
	\inputminted[firstline=91,lastline=110]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/MainActivity.java}
...
\begin{figure}[H]
	\inputminted[firstline=133,lastline=142]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/MainActivity.java}
	\caption{\textbf{Acceso a los sensores y creación del objeto \textit{PositionSender}}: }
	\label{fig:mainactivity_setupsensorposition}
\end{figure}

\begin{figure}[H]
	\inputminted[firstline=161,lastline=174]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/MainActivity.java}
	\caption{Hilo de envío de la posición al servidor de control}
	\label{fig:mainactivity_hilosender}
\end{figure}

\begin{figure}[H]
	\inputminted[firstline=181,lastline=212]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/MainActivity.java}
...
\begin{figure}[H]
	\inputminted[firstline=278,lastline=285]{java}{../01-CardboardApps/SurfaceViewCarboard/app/src/main/java/com/example/borch/surfaceviewcarboard/MainActivity.java}
...
\begin{figure}[H]
	\inputminted[firstline=1,lastline=11]{bash}{../02-UDPStreamers/VLCRtpServer/deploy.sh}
...
\begin{figure}[H]
	\inputminted[firstline=1,lastline=8]{cpp}{../03-ServoServers/ArduinoCode/servo_serial_write/servo_serial_write.ino}
...
\begin{figure}[H]
	\inputminted[firstline=9,lastline=27]{cpp}{../03-ServoServers/ArduinoCode/servo_serial_write/servo_serial_write.ino}
...
\begin{figure}[H]
	\inputminted[firstline=27,lastline=34]{cpp}{../03-ServoServers/ArduinoCode/servo_serial_write/servo_serial_write.ino}
...
\begin{figure}[H]
	\inputminted[firstline=36,lastline=43]{cpp}{../03-ServoServers/ArduinoCode/servo_serial_write/servo_serial_write.ino}
...
%\todo[inline]{Anexo código: \currentname}
\begin{figure}[H]
	\inputminted[firstline=28,lastline=34]{python}{../03-ServoServers/ServoControlPython/control_servo.py}
...
\begin{figure}[H]
	\inputminted[firstline=62,lastline=83]{python}{../03-ServoServers/ServoControlPython/control_servo.py}
...
\begin{figure}[H]
	\inputminted[firstline=7,lastline=16]{python}{../03-ServoServers/ServoControlPython/udp_server.py}
	\caption{\textbf{Inicialización de recursos del servidor de control}. }
	\label{fig:setup_udp_server}
\end{figure}

\begin{figure}[H]
	\inputminted[firstline=17,lastline=28]{python}{../03-ServoServers/ServoControlPython/udp_server.py}
