...
\usepackage{listings} 	%Para importar código
\usepackage{minted}		%Para que se vea bonito el código
\usepackage{todonotes}	%Para marcar lo que queda por hacer
\usepackage{nameref}	%Para referenciar la sección actual
...
\newcommand{\tutor}{Tutor: Francisco Saiz López}
...
\newcommand{\fpservidorcontrol}{../../src/ControlServer/}
\newcommand{\fpservidoresvideo}{../../src/VideoServers/}
\newcommand{\fpandroidclient}{../../src/AndroidClient/}
\newcommand{\fparduinocode}{../../src/ArduinoCode/}
