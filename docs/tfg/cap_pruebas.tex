...
Las distinas herraminetas que se han contemplado para desplegar los servidores multimedia son las siguientes: \textbf{FFMpeg, FFServer, GStreamer y VLC (cvlc)}. Todas éstas se ejecutan, de manera similar, a través de la terminal de Linux y los parámetros de los streams se especifican como argumentos de los correspondientes ejecutables.
...
En el cuadro \ref{tabla:pruebas_qos} pueden se encuentran las pruebas más significativas de todas las llevadas a cabo, en las cuales se comentan las prestaciones que ofrece la configuración dada.
